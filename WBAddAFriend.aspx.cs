...
{
    public partial class WBAddAFriend : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            _currentUserId = long.Parse(Request.Cookies["UserID"].Value);
        ...
        protected void btnIndex_Click(object sender, EventArgs e)   //duplicated from AddAFriend which has btnIndex, but we r redirecting back to dashboard
        {
