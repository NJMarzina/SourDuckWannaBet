<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddAFriend.aspx.cs" Inherits="SourDuckWannaBet.AddAFriend" Async="true"%>
<!DOCTYPE html>
...
<body>
    <form id="frmAddAFriend" runat="server">
        <div id="header">
            <asp:Button ID="btnIndex" runat="server" Text="Index" OnClick="btnIndex_Click" CssClass="btn" />
        </div>
