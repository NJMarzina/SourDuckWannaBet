<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendABet.aspx.cs" Inherits="SourDuckWannaBet.SendABet" Async="true" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="form-container">
            ...
            <div class="form-group">
                <label for="txtSenderUsername">Your Username:</label>
                <asp:TextBox ID="txtSenderUsername" runat="server" CssClass="form-control" placeholder="Enter your username"></asp:TextBox>
            </div>
